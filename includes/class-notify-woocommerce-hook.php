...
class Notify_WooCommerce_Hook implements Notify_Register_Interface {
	protected $notification_ins;

	public function __construct( Notify_WooCommerce_Notification $notification_ins ) {
		$this->notification_ins = $notification_ins;
	}

	public function register() {
		notify_add_actions( $this->get_core_actions() );
	}
