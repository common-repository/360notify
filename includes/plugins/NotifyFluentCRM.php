    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Subscribed status WhatsApp message', NOTIFY_TEXT_DOMAIN ),
            ...
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], you have unsubscribed and will no longer receive trending contents.', NOTIFY_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_pending',
                'label'   => __( 'Pending status WhatsApp message', NOTIFY_TEXT_DOMAIN ),
