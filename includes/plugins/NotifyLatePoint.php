    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Approved WhatsApp message', NOTIFY_TEXT_DOMAIN ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Greetings [cust_first_name], your appointment for [service_name] on [booking_start_date] [booking_start_time] is [booking_status]', NOTIFY_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_pending',
                'label'   => __( 'Pending approval WhatsApp message', NOTIFY_TEXT_DOMAIN ),
            ...
            array(
                ...
                'label'   => __( 'Payment pending WhatsApp message', NOTIFY_TEXT_DOMAIN ),
