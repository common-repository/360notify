    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Member membership change', NOTIFY_TEXT_DOMAIN ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your current membership is [membership_level_name]', NOTIFY_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_member_status_change',
                'label'   => __( 'Member status change', NOTIFY_TEXT_DOMAIN ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your membership is [status_name]', NOTIFY_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_bundles_added_to_member',
                'label'   => __( 'Bundles added to member', NOTIFY_TEXT_DOMAIN ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], [bundle_name] has been added to your account successfully', NOTIFY_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_bundles_status_change',
                'label'   => __( 'Bundles status changed', NOTIFY_TEXT_DOMAIN ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your [bundle_name] is [bundle_status_name]', NOTIFY_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_payment_received',
                'label'   => __( 'Payment received', NOTIFY_TEXT_DOMAIN ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], your payment of [order_total] is successful', NOTIFY_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_payment_rebill',
                'label'   => __( 'Payment rebill', NOTIFY_TEXT_DOMAIN ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], recurring payment of [order_total] is successful', NOTIFY_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_payment_rebill_declined',
                'label'   => __( 'Payment rebill declined', NOTIFY_TEXT_DOMAIN ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], recurring payment of [order_total] is unsuccessful, talk to our support', NOTIFY_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'notifysms_automation_sms_template_refund_issued',
                'label'   => __( 'Refund issued', NOTIFY_TEXT_DOMAIN ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], we are sorry to see you go, we have refunded your payment of [order_total]', NOTIFY_TEXT_DOMAIN )
            ),
        );
    }
