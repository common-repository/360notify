...
class Notify_SendSMS_View implements Notify_Register_Interface {
	...
	public function set_sendsms_setting_section( $sections ) {
		$sections[] = array(
            ...
            'title'            => __( 'Send WhatsApp', NOTIFY_TEXT_DOMAIN ),
            'submit_button'    => get_submit_button( __('Send Message', NOTIFY_TEXT_DOMAIN ), 'primary large', 'sendMessage', true ,array('id' => 'sendMessage')),
	...
	public function set_sendsms_setting_field( $setting_fields ) {
		...
		$setting_fields['notifysms_sendsms_setting'] = array(
			array(
				...
				'label'   => __( 'To', NOTIFY_TEXT_DOMAIN ),
				'desc'    => __('Select the recipients you wish to broadcast your message', NOTIFY_TEXT_DOMAIN ),
				'type'    => 'select',
				'default' => 'customer_all',
				'options' => array(
					'customer_all'     => __('All users', NOTIFY_TEXT_DOMAIN ),
					'customer'         => __('Specific users', NOTIFY_TEXT_DOMAIN ),
					'phones'           => __('Specific phone number', NOTIFY_TEXT_DOMAIN ),
					'spec_group_ppl'   => __('Specific Group of People', NOTIFY_TEXT_DOMAIN ),
				)
			),
			array(
				'name'    => 'notifysms_sendsms_users',
				'label'   => __( 'Users', NOTIFY_TEXT_DOMAIN ),
				'desc'    => __('Note: Please ensure <b>Mobile Number</b> field at <b>Additional profile information</b> is not empty for selected users.<br />', NOTIFY_TEXT_DOMAIN ),
				'type'    => 'selectm',
				'default' => 'auto',
			...
			array(
				...
				'label'   => __( 'Recipients', NOTIFY_TEXT_DOMAIN ),
				'desc'    => __('(Please insert country code along with mobile numbers,<br>e.g. 60124512978,60198745123,60161237841)', NOTIFY_TEXT_DOMAIN ),
				'type'    => 'textarea',
				'rows'    => '8',
				'cols'    => '500',
				'css'     => 'min-width:350px',
            ...
            array(
				...
				'label'   => __( 'Filter By', NOTIFY_TEXT_DOMAIN ),
				'desc'    => __('Select the recipients you wish to filter by<br />', NOTIFY_TEXT_DOMAIN ),
				'type'    => 'select',
				'default' => '-1',
				'options' => array(
                    '-1'          => "Select Filter",
            ...
            array(
				...
				'label'   => __( 'Criteria', NOTIFY_TEXT_DOMAIN ),
				'desc'    => __('Select the criteria you wish to filter by<br />', NOTIFY_TEXT_DOMAIN ),
				'type'    => 'select',
                // 'css'     => 'min-width:350px;',
				'default' => '-1',
				'options' => array(),
			...
			array(
				...
				'label'   => __( 'Message', NOTIFY_TEXT_DOMAIN ),
    ...
    */
    ...
    public function display_send_sms_success()
    {
        ...
        <div class="notice notice-success is-dismissible">
            <p><?php _e( 'WhatsApp Sent!', NOTIFY_TEXT_DOMAIN ); ?></p>
        </div>
        <?php
    }
    ...
    public function load_scripts()
    {
        ...
        <script>
            ...
            jQuery(function ($) {
                ...
                //countCharactersAndSMS('textarea#notifysms_sendsms_setting\\[notifysms_sendsms_message\\]', 'text-bulksms-characters', 'text-bulksms-sms');
